                        ...
                        <table className=' w-[95%] table-auto'>
                            <thead>
                                <tr >
                                    ...
                                    <th className='text-center p-0 text-xl max-md:text-base  text-white rounded-md'> <div className='bg-[#054bb4] py-2 w-full h-full '>Marks</div></th>
                                    <th className='text-center p-0 text-xl max-md:text-base text-white rounded-md'><div className='bg-[#054bb4] py-2 w-full  rounded-tr-md'>Submittion time</div></th>
                                </tr>
                            </thead>
                            <tbody >
                                {
                                    found && attendance.map((item, index) => (
                                        <>
                                            <tr key={index} className={`relative rounded-lg ${index % 2 == 0 ? 'bg-white' : 'bg-gray-200'}`}>
                                                ...
                                                <td className='text-start border-y-[6px] border-white pl-4 py-2 text-lg max-md:text-base '>{item[0]}</td>
                                                <td className='text-center border-y-[6px] border-white px-2 py-2 text-lg max-md:text-base'>{item[2]}</td>
                                                <td className='text-center border-y-[6px] border-white rounded-r-lg px-2 text-lg max-md:text-base '>{item[1].slice(0, 16)}</td>
                                            </tr>
                                        </>
                                    ))
                                    ...
                                    found && absence.map((item, index) => (
                                        <>
                                            <tr key={index} className={`relative rounded-lg ${index % 2 == 0 ? 'bg-white' : 'bg-gray-200'}`}>
                                                ...
                                                <td className='text-center border-y-[6px] border-white px-2 py-2 text-lg max-md:text-base'>-</td>
