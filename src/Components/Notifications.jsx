...
const Notifications = () => {
    ...
    return (
        <>
            {
                !toggleNotifications ? (
                    <div className='w-[300px] h-[45px] fixed z-[200] bottom-0 right-5 bg-[#054bb4]  rounded-t-md'>
                    ...
                    <div className={`w-[300px] sm:h-[500px] ${isKeyboardVisible ? 'max-sm:h-[55%]': 'max-sm:h-[80%]'} fixed z-[200] bottom-0 right-5 bg-white rounded-t-md flex flex-col justify-between shadow-lg`}>
